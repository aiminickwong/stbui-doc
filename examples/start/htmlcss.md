...
```html
<!-- Recommended -->
<script src="//stbui.stbui.com/example.js"></script>
```

```html
<!-- Not recommended -->
<script src="http://stbui.stbui.com/example.js"></script>
```

```css
/* Recommended */
.example {
  background: url(//stbui.stbui.com/images/example);
}
```
...
/* Not recommended */
.example {
  background: url(http://stbui.stbui.com/images/example);
}
```
...
```html
<!-- Recommended -->
<link rel="stylesheet" href="//stbui.stbui.com/example.css">
...
<!-- Not recommended -->
<script src="//stbui.stbui.com/example"
